...
Plugin URI: http://www.svil4ok.com/wordpress-plugins/bottom-bar/
Description: Bottom Bar is a WordPress plugin that includes a several features for creating interactive and user-friendly toolbar. <a href="http://www.svil4ok.com/wordpress-plugins/bottom-bar/">More information here</a>.
Version: 0.1.7
Author: Svilen Popov
...
function bottom_bar_header() {
	...
	$bb_head = "<link type='text/css' href='".$bb_url."/css/bottom-bar.css' rel='stylesheet' /> \n";
	$bb_head .= "<script type='text/javascript' src='".$bb_url."/controllers/jquery.min.js'></script> \n";
	$bb_head .= "<script type='text/javascript' src='".$bb_url."/controllers/bottom-bar.js'></script> \n";
	echo $bb_head;
}
...
function bottom_bar() {
	...
	<ul id=\"mainpanel\">    	
		...
		<div class=\"subpanel largesubpanel\">
			...
			<ul>
				". bb_recent_comments(get_settings('bb-max-comments')) ."
			</ul>
		</div>
		</li>
...
add_filter('wp_head', 'bottom_bar_header');
